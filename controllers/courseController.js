...
class CourseController {
     async add(req, res, next) {
          try {
               ...
               const checkAvailability = await prisma.course.findFirst({ where: { title } })
     ...
     async update(req, res, next) {
          try {
               ...
               const checkId = await prisma.course.findFirst({ where: { id: Number(id) } })
     ...
     async getById(req, res, next) {
          try {
               ...
               const course = await prisma.course.findFirst({ where: { id: Number(id) } })
